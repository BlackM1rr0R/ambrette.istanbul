...
const routes = {
  home: routeItem(1, "home", "/", Home, {
    title: "Home - Perfume Shop",
    description: "Welcome to the best perfume shop.",
  }),
  about: routeItem(2, "about", "/about", About, {
    title: "About Us - Perfume Shop",
    description: "Learn more about our perfume shop.",
  }),
  ...
  dior: routeItem(6, "dior", "/brend/:brendId", DiorPerfume, {
    title: "Dior Perfume Collection",
    description: "Explore the Dior perfume collection.",
  }),
  brendlogo: routeItem(7, "brendlogo", "/brends", BrendLogo, {
    title: "Perfume Brands",
    description: "Browse through different perfume brands.",
  }),
